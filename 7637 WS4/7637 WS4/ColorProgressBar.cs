...
namespace _7637_WS4
{
    class ColorProgressBar:Control
    {
        ...
        /// <summary>
        /// Свойство отвечающее за отображение контрола. AsIs - как в стандартном, Percent - отображение в процентах
        /// </summary>
